(function() {
    ...
    function r(a, b) {
        if (b) a: {
            ...
            a = a[a.length - 1];d = c[a];b = b(d);b != d && b != null && p(c, a, {
                configurable: !0,
                writable: !0,
                value: b
            })
    ...
    var t;
    if (typeof Object.setPrototypeOf == "function") t = Object.setPrototypeOf;
    else {
        var u;
        a: {
            var ea = {
    ...
    y.prototype.getNextAddressJsc = function() {
        return this.g
    };
    y.prototype.getYieldResultJsc = function() {
        return this.m
    };
    ...
    y.prototype.jumpThroughFinallyBlocks = y.prototype.T;
    ...
    y.prototype.W = function(a, b) {
        ...
        else return this.j = a, this.u(c.value, b)
    };
    y.prototype.yieldAll = y.prototype.W;
    ...
    y.prototype.setFinallyBlock = y.prototype.V;
    ...
    y.prototype.U = function(a, b) {
        ...
        (b = this.h = this.h || b) ? b.O ? this.g = this.l || this.i : b.C != void 0 && this.i < b.C ? (this.g = b.C, this.h = null) : this.g = this.i: this.g = a
    };
    y.prototype.leaveFinallyBlock = y.prototype.U;
    ...
    function la(a, b) {
        z(a.g);
        var c = a.g.j;
        if (c) return D(a, "return" in c ? c["return"] : function(d) {
            return {
                value: d,
                done: !0
            }
    ...
    function D(a, b, c, d) {
        try {
            var h = b.call(a.g.j, c);
            ja(h);
            if (!h.done) return a.g.o = !1, h;
            var k = h.value
        } catch (f) {
            return a.g.j = null, A(a.g, f), E(a)
        }
        a.g.j = null;
        d.call(a.g, k);
        return E(a)
    ...
    function ma(a) {
        this.next = function(b) {
            z(a.g);
            a.g.j ? b = D(a, a.g.j.next, b, a.g.B) : (a.g.B(b), b = E(a));
            return b
        };
        this.throw = function(b) {
            z(a.g);
            a.g.j ? b = D(a, a.g.j["throw"], b, a.g.B) : (A(a.g, b), b = E(a));
            return b
        };
    ...
    function na(a) {
        ...
        return new Promise(function(d, h) {
            function k(f) {
                f.done ? d(f.value) : Promise.resolve(f.value).then(b, c).then(k, h)
            }
            k(a.next())
        })
    }
    ...
    r("Promise", function(a) {
        ...
        b.prototype.J = function(f, e) {
            ...
            var l = this;
            this.g == null ? k.h(g) : this.g.push(g);
            this.o = !0
        };
        b.resolve = d;
        b.reject = function(f) {
        ...
        b.race = function(f) {
            return new b(function(e, g) {
                for (var l = v(f), m = l.next(); !m.done; m = l.next()) d(m.value).J(e, g)
            })
        };
        b.all = function(f) {
            var e = v(f),
                g = e.next();
            return g.done ? d([]) : new b(function(l, m) {
                function w(aa) {
                    return function(ba) {
                        x[aa] = ba;
                        B--;
                ...
                var x = [],
                    B = 0;
                do x.push(void 0), B++, d(g.value).J(w(x.length - 1), m), g = e.next(); while (!g.done)
            })
        };
        return b
    });
    ...
    r("WeakMap", function(a) {
        ...
        if (function() {
                ...
                try {
                    ...
                    if (m.get(g) != 2 || m.get(l) != 3) return !1;
                    m.delete(g);
                    m.set(l, 4);
                    return !m.has(g) && m.get(l) == 4
                } catch (w) {
                    return !1
                }
            }()) return a;
        ...
        b.prototype.set = function(g, l) {
            ...
            h(g);
            if (!G(g, f)) throw Error("WeakMap key fail: " + g);
            g[f][this.g] = l;
            return this
        };
    ...
    r("Map", function(a) {
        ...
        function d(e, g) {
            var l = g && typeof g;
            l == "object" || l == "function" ? k.has(g) ? l = k.get(g) : (l = "" + ++f, k.set(g, l)) : l = "p_" + g;
            var m = e[0][l];
            if (m && G(e[0], l))
        ...
        if (function() {
                ...
                try {
                    ...
                    var l = g.entries(),
                        m = l.next();
                    if (m.done || m.value[0] != e || m.value[1] != "s") return !1;
                    m = l.next();
        ...
        h.prototype.forEach = function(e, g) {
            for (var l = this.entries(), m; !(m = l.next()).done;) m = m.value, e.call(g, m[1], m[0], this)
        };
    ...
    r("Set", function(a) {
        ...
        if (function() {
                ...
                try {
                    ...
                    k = h.next();
                    return k.done || k.value[0] == c || k.value[0].x != 4 || k.value[1] != k.value[0] ? !1 : h.next().done
                } catch (f) {
                    return !1
                }
            }()) return a;
    ...
    r("Array.from", function(a) {
        return a ? a : function(b, c, d) {
            ...
            if (typeof k == "function") {
                b = k.call(b);
                for (var f = 0; !(k = b.next()).done;) h.push(c.call(d, k.value, f++))
            } else
                for (k = b.length, f = 0; f < k; f++) h.push(c.call(d, b[f], f));
            return h
        }
    });
    /*
    ...
    */
    ...
    function J(a, b) {
        a = a.split(".");
        for (var c = H, d; a.length && (d = a.shift());) a.length || b === void 0 ? c[d] && c[d] !== Object.prototype[d] ? c = c[d] : c = c[d] = {} : c[d] = b
    }
    ...
    function ta(a, b) {
        ...
        a.ea = function(d, h, k) {
            ...
            return b.prototype[h].apply(d, f)
        }
    };
    var ua = Array.prototype.indexOf ? function(a, b) {
        ...
        va = Array.prototype.forEach ? function(a, b, c) {
            ...
            for (var d = a.length, h = typeof a === "string" ? a.split("") : a, k = 0; k < d; k++) k in h && b.call(c, h[k], k, a)
        };
    ...
    */
    ...
    function Ya(a) {
        Ra.test(a) && (a.indexOf("&") != -1 && (a = a.replace(La, "&amp;")), a.indexOf("<") != -1 && (a = a.replace(Ma, "&lt;")), a.indexOf(">") != -1 && (a = a.replace(Na, "&gt;")), a.indexOf('"') != -1 && (a = a.replace(Oa, "&quot;")), a.indexOf("'") != -1 && (a = a.replace(Pa, "&#39;")), a.indexOf("\x00") != -1 && (a = a.replace(Qa, "&#0;")));
        return a
    };
    var Za, Q;
    a: {
    ...
    function fb() {
        for (var a = S(), b = RegExp("([A-Z][\\w ]+)/([^\\s]+)\\s*(?:\\((.*?)\\))?", "g"), c = [], d; d = b.exec(a);) c.push([d[1], d[2], d[3] || void 0]);
        a = eb(c);
        if (db()) a: {
            if (Za && T)
        ...
        else b = (S().indexOf("Chrome") != -1 || S().indexOf("CriOS") != -1) && (db() || S().indexOf("Edge") == -1) || S().indexOf("Silk") != -1;
    ...
    n.unsubscribe = function(a, b, c) {
        if (a = this.h[a]) {
            var d = this.g;
            if (a = a.find(function(h) {
                    return d[h + 1] == b && d[h + 2] == c
                })) return this.M(a)
        }
        return !1
    };
    n.M = function(a) {
        ...
        if (b) {
            var c = this.h[b];
            this.m != 0 ? (this.l.push(a), this.g[a + 1] = function() {}) : (c && wa(c, a), delete this.g[a], delete this.g[a + 1], delete this.g[a + 2])
        }
        return !!b
    };
    n.P = function(a, b) {
        ...
        if (c) {
            var d = Array(arguments.length - 1),
                h = arguments.length,
                k;
            for (k = 1; k < h; k++) d[k - 1] = arguments[k];
            if (this.u)
                for (k = 0; k < c.length; k++) h = c[k], hb(this.g[h + 1], this.g[h + 2], d);
            else {
                this.m++;
                try {
                    for (k = 0, h = c.length; k < h && !this.i; k++) {
                        var f = c[k];
                        this.g[f + 1].apply(this.g[f + 2], d)
                    }
                } finally {
                    if (this.m--, this.l.length > 0 && this.m == 0)
                        for (; c = this.l.pop();) this.M(c)
                }
            }
            return k != 0
        }
    ...
    n.clear = function(a) {
        if (a) {
            var b = this.h[a];
            b && (b.forEach(this.M, this), delete this.h[a])
    ...
    function kb(a, b, c) {
        if (Array.isArray(b))
            for (var d = 0; d < b.length; d++) kb(a, String(b[d]), c);
            ...
            switch (c.g) {
                ...
                case 2:
                    ...
                    return c.u(Promise.all(b.map(function(d) {
                        var h;
                        return F(function(k) {
                            if (k.g == 1) return k.I(2), k.u(navigator.permissions.query({
                                name: "top-level-storage-access",
                                requestedOrigin: d
                            }), 4);
                            if (k.g != 2) return h = k.m, h.state === "prompt" && a.g.push(d), k.H(0);
                            k.F();
                            k.G()
                        })
                    })), 4);
    ...
    function sb() {
        for (var a = v(qb), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }
    ...
    function X(a, b) {
        ...
        if (a = typeof a === "string" ? c.getElementById(a) : a) {
            ...
            if (!c) {
                ...
                c = a.attributes;
                d = 0;
                for (var h = c.length; d < h; d++) {
                    var k = c[d].value;
                    k != null && k !== "" && k !== "null" && b.setAttribute(c[d].name, k)
                }
                ...
                d = [];
                for (var f in a) kb(f, a[f], d);
                f = c + d.join("&");
                if (xb.yt_embedsEnableIframeSrcWithIntent) {
                    var e = e === void 0 ? Ua : e;
                    a: if (e = e === void 0 ? Ua : e, f instanceof L) e = f;
                        else {
                            for (a = 0; a < e.length; ++a)
                                if (c =
                                    e[a], c instanceof Ta && c.Y(f)) {
                                    e = new L(f);
                                    break a
                                }
                            e = void 0
                    ...
                    for (a = 0; a < f.length; a++) b.sandbox.supports && !b.sandbox.supports(f[a]) || b.sandbox.add(f[a]);
                    if (e instanceof L)
                        if (e instanceof L) e = e.g;
                        else throw Error("");
                    else e = Va.test(e) ? e : void 0;
                    e !== void 0 && (b.src = e);
                    b.sandbox.add("allow-presentation",
            ...
            if (window.postMessage) {
                ...
                Ab(this);
                b = Y(this, "events");
                for (var g in b) b.hasOwnProperty(g) && this.addEventListener(g, b[g]);
                for (var l in rb) rb.hasOwnProperty(l) && Bb(this, l)
            }
        }
    }
    n = X.prototype;
    ...
    function Eb(a) {
        if (!a.g || !a.g.contentWindow) return !1;
        a.sendMessage({
            event: "listening"
        });
        return !0
    ...
    function Cb(a, b) {
        a.B[b] || (a.B[b] = !0, Db(a, "addEventListener", [b]))
    }
    ...
    function yb(a, b) {
        ...
        if (d) {
            if (I(d)) try {
                ...
                console.error("Invalid embed config JSON", h)
            }
            c.embed_config = d
        }
        ...
        c.widgetid = a.id;
        window.location.href && va(["debugjs", "debugcss"], function(h) {
            var k = window.location.href;
            var f = k.search(lb);
            b: {
                var e = 0;
                for (var g = h.length;
                    (e = k.indexOf(h, e)) >= 0 && e < f;) {
                    var l = k.charCodeAt(e - 1);
                    if (l == 38 || l == 63)
                        if (l = k.charCodeAt(e + g), !l || l == 61 || l == 38 || l == 35) break b;
                    e += g + 1
                }
                e = -1
            }
            if (e < 0) k = null;
                ...
                if (g < 0 || g > f) g = f;
                e += h.length + 1;
                k = decodeURIComponent(k.slice(e, g !== -1 ? g : 0).replace(/\+/g, " "))
            }
            k !== null && (c[h] = k)
        });
    ...
    function Ib(a, b) {
        ...
        for (var c = b.next(), d = {}; !c.done; d = {
                v: void 0
            }, c = b.next()) d.v = c.value, a[d.v] || (d.v === "getCurrentTime" ? a[d.v] = function() {
            var h = this.playerInfo.currentTime;
            if (this.playerInfo.playerState === 1) {
                var k = (Date.now() / 1E3 - this.playerInfo.currentTimeLastUpdated_) * this.playerInfo.playbackRate;
                k > 0 && (h += Math.min(k, 1))
            }
            return h
        } : vb(d.v) ? a[d.v] = function(h) {
            return function() {
                this.playerInfo = {};
                this.A = {};
                Db(this, h.v, arguments);
                return this
            }
        }(d) : wb(d.v) ? a[d.v] = function(h) {
            return function() {
                var k = h.v,
                    f = 0;
                k.search("get") === 0 ? f = 3 : k.search("is") === 0 && (f = 2);
                return this.playerInfo[k.charAt(f).toLowerCase() + k.substring(f + 1)]
            }
        }(d) : a[d.v] = function(h) {
            return function() {
                Db(this, h.v, arguments);
    ...
    n.getOption = function(a, b) {
        if (this.A.namespaces && a && b && this.A[a]) return this.A[a][b]
    };
    ...
    function Fb(a, b, c) {
        Z || (Z = {}, Jb = new Set, Lb.addEventListener("message", function(d) {
            a: if (Jb.has(d.origin)) {
                try {
                    var h = JSON.parse(d.data)
                } catch (e) {
                    break a
                }
                var k = Z[h.id];
                if (k && d.origin === k.X) switch (d = k.aa, d.m = !0, d.m && (va(d.l, d.sendMessage, d), d.l.length = 0), k = h.event, h = h.info, k) {
                    case "apiInfoDelivery":
                        if (I(h))
                            for (var f in h) h.hasOwnProperty(f) && (d.A[f] = h[f]);
                        break;
                    case "infoDelivery":
                        Hb(d, h);
                        break;
                    case "initialDelivery":
                        I(h) && (clearInterval(d.h), d.playerInfo = {}, d.A = {}, Ib(d, h.apiInterface), Hb(d, h));
                        break;
    ...
    var Lb = window;
    J("YT.PlayerState.UNSTARTED", -1);
    J("YT.PlayerState.ENDED", 0);
    J("YT.PlayerState.PLAYING", 1);
    J("YT.PlayerState.PAUSED", 2);
    J("YT.PlayerState.BUFFERING", 3);
    J("YT.PlayerState.CUED", 5);
    J("YT.get", function(a) {
        return V[a]
    });
    J("YT.scan", sb);
    J("YT.subscribe", function(a, b, c) {
        W.subscribe(a, b, c);
        rb[a] = !0;
        for (var d in V) V.hasOwnProperty(d) && Bb(V[d], a)
    });
    J("YT.unsubscribe", function(a, b, c) {
        W.unsubscribe(a, b, c)
    });
    J("YT.Player", X);
