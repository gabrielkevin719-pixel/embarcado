...
(function() {
    ...
    (function() {
            ...
            return function(parameters, TagManager) {
                ...
                this.fire = function() {
                    ...
                    if (html && html.type === 'JoinedVariable') {
                        ...
                        var value = '',
                            varReturn, theVarValue, isVariable, hasValueSet;
        ...
        Templates['CustomJsFunctionVariable5e08aada'] = (function() {
            return function(parameters, TagManager) {
                this.get = function indexaClickId() {
                    ...
                    // Check for indexaclickid in the URL query parameters or cookies
                    const indexaClickId = getQueryParam('indexaclickid') || getCookie('indexaclickid');

                    // Output the value of indexaclickid
                    return indexaClickId || "";
                };
            }
        })();
                ...
                if (typeof window.Matomo !== "object") {
                    window.Matomo = window.Piwik = (function() {
                        ...
                        function U(cv, cp) {
                            var bW = this,
                                bp = "mtm_consent",
                                c3 = "mtm_cookie_consent",
                                dc = "mtm_consent_removed",
                                ci = af(K.domain, X.location.href, O()),
                                dk = P(ci[0]),
                                b0 = p(ci[1]),
                                bB = p(ci[2]),
                                di = false,
                                ...
                                bX = 500,
                                dn = true,
                                c9, bh, b5, b2, aw, cJ = ["pk_campaign", "mtm_campaign", "piwik_campaign", "matomo_campaign", "utm_campaign", "utm_source", "utm_medium"],
                                bU = ["pk_kwd", "mtm_kwd", "piwik_kwd", "matomo_kwd", "utm_term"],
                                cX = ["mtm_campaign", "matomo_campaign", "mtm_cpn", "pk_campaign", "piwik_campaign", "pk_cpn", "utm_campaign", "mtm_keyword", "matomo_kwd", "mtm_kwd", "pk_keyword", "piwik_kwd", "pk_kwd", "utm_term", "mtm_source", "pk_source", "utm_source", "mtm_medium", "pk_medium", "utm_medium", "mtm_content", "pk_content", "utm_content", "mtm_cid", "pk_cid", "utm_id", "mtm_clid", "mtm_group", "pk_group", "mtm_placement", "pk_placement"],
                                ck = ["chatgpt.com", "chat.openai.com"],
                                bw = "_pk_",
                                aD = "pk_vid",
                                ba = 180,
                                dr, bD, b6 = false,
                            ...
                            function aL(dQ) {
                                ...
                                var dO = new RegExp("(^|;)[ ]*" + dQ + "=([^;]*)"),
                                    dP = dO.exec(K.cookie);
                                return dP ? W(dP[2]) : 0
                            }
                            bQ = !aL(dc);

                            function dJ(dS, dT, dW, dV, dQ, dR, dU) {
                                if (by && dS !== dc) {
                                    return
                                }
                                var dP;
                                if (dW) {
                                    dP = new Date();
                                    dP.setTime(dP.getTime() + dW)
                                }
                                if (!dU) {
                                    dU = "Lax"
                                }
                                K.cookie = dS + "=" + u(dT) + (dW ? ";expires=" + dP.toGMTString() : "") + ";path=" + (dV || "/") + (dQ ? ";domain=" + dQ : "") + (dR ? ";secure" : "") + ";SameSite=" + dU;
                                if ((!dW || dW >= 0) && aL(dS) !== String(dT)) {
                                    var dO = "There was an error setting cookie `" + dS + "`. Please check domain and path.";
                                    ap(dO)
                                }
                            }
                            ...
                            function c7(dQ, dO) {
                                var dP;
                                dQ = String(dQ).toLowerCase();
                                dO = String(dO).toLowerCase();
                                if (dQ === dO) {
                                    return true
                                }
                                if (dO.slice(0, 1) === ".") {
                                    ...
                                    dP = dQ.length - dO.length;
                                    if ((dP > 0) && (dQ.slice(dP) === dO)) {
                                        return true
                                    }
                                }
                                return false
                            ...
                            function cD(dO) {
                                ...
                                if (dO.indexOf("//") !== 0 && dO.indexOf("http") !== 0) {
                                    if (dO.indexOf("*") === 0) {
                                        dO = dO.substr(1)
                                    }
                                    if (dO.indexOf(".") === 0) {
                            ...
                            function aA(dQ, dS) {
                                var dO, dP, dR;
                                for (dO = 0; dO < aG.length; dO++) {
                                    dP = P(aG[dO]);
                                    dR = cD(aG[dO]);
                                    if (c7(dQ, dP) && bf(dS, dR)) {
                                        return true
                                    }
                                }
                                return false
                            ...
                            function a6(dR) {
                                var dP, dO, dQ;
                                for (dP = 0; dP < aG.length; dP++) {
                                    dO = P(aG[dP].toLowerCase());
                                    if (dR === dO) {
                                        return true
                                    }
                                    if (dO.slice(0, 1) === ".") {
                                        ...
                                        dQ = dR.length - dO.length;
                                        if ((dQ > 0) && (dR.slice(dQ) === dO)) {
                                            return true
                                        }
                                    }
                                }
                            ...
                            function cL(dO) {
                                ...
                                for (dP = 0; dP < cU.length; dP++) {
                                    dQ = P(cU[dP]);
                                    dS = cD(cU[dP]);
                                    if (dQ.indexOf("www.") === 0) {
                                        dQ = dQ.substr(4)
                                    }
                                    if (c7(dR, dQ) && bf(dT, dS)) {
                                        return true
                                    }
                                }
                                return false
                            ...
                            function be(dO) {
                                var dP, dQ, dS, dT = d(dO),
                                    dR = cD(dO);
                                if (dT.indexOf("www.") === 0) {
                                    dT = dT.substr(4)
                                }
                                if (ck && ck.length) {
                                    for (dP = 0; dP < ck.length; dP++) {
                                        dQ = P(ck[dP]);
                                        dS = cD(ck[dP]);
                                        if (dQ.indexOf("www.") === 0) {
                                            dQ = dQ.substr(4)
                                        }
                                        if (c7(dT, dQ) && bf(dR, dS)) {
                                            return true
                                        }
                                    }
                                }
                            ...
                            function cg(dO) {
                                var dQ, dP;
                                if (be(bB) || (dp !== true && !c0)) {
                                    for (dP = 0; dP < cJ.length; dP++) {
                                        dO = j(dO, cJ[dP])
                                    }
                                    for (dP = 0; dP < bU.length; dP++) {
                                        dO = j(dO, bU[dP])
                                    }
                                    for (dP = 0; dP < cX.length; dP++) {
                                        dO = j(dO, cX[dP])
                                    }
                                }
                                dO = j(dO, aD);
                                dO = j(dO, "ignore_referrer");
                                dO = j(dO, "ignore_referer");
                                for (dP = 0; dP < cA.length; dP++) {
                                    dO = j(dO, cA[dP])
                                }
                                if (b2) {
                                    dQ = new RegExp("#.*");
                                    return dO.replace(dQ, "")
                                }
                                return dO
                            }
                            ...
                            function cH(dO, dQ) {
                                dO = dO.replace("send_image=0", "send_image=1");
                                var dP = new Image(1, 1);
                                dP.onload = function() {
                                    I = 0;
                            ...
                            function c4(dO) {
                                ...
                                return dO && (dO.length > 2000 || dO.indexOf('{"requests"') === 0)
                            }
                            ...
                            function bi(dS, dV, dU) {
                                ...
                                var dP = aM;
                                try {
                                    var dO = new Blob([dS], dR);
                                    if (dU && !c4(dS)) {
                                        dO = new Blob([], dR);
                                        dP = dP + (dP.indexOf("?") < 0 ? "?" : "&") + dS
                                    }
                                    dW = g.sendBeacon(dP, dO)
                                } catch (dT) {
                                    return false
                                }
                                if (dW && typeof dV === "function") {
                                    dV({
                                        request: dS,
                                        trackerUrl: aM,
                                        success: true,
                            ...
                            function dy(dP, dQ, dO) {
                                ...
                                setTimeout(function() {
                                    ...
                                    var dT;
                                    try {
                                        var dS = X.XMLHttpRequest ? new X.XMLHttpRequest() : X.ActiveXObject ? new ActiveXObject("Microsoft.XMLHTTP") : null;
                                        dS.open("POST", aM, true);
                                        dS.onreadystatechange = function() {
                                            if (this.readyState === 4 && !(this.status >= 200 && this.status < 300)) {
                                                var dU = m && bi(dP, dQ, dO);
                                                if (!dU && dO) {
                                                    cH(dP, dQ)
                                                } else {
                                                    if (typeof dQ === "function") {
                                                ...
                                                if (this.readyState === 4 && (typeof dQ === "function")) {
                                                    dQ({
                                                        request: dP,
                                                        trackerUrl: aM,
                                                        success: true,
                                        ...
                                        dS.setRequestHeader("Content-Type", cT);
                                        dS.withCredentials = true;
                                        dS.send(dP)
                                    } catch (dR) {
                                        dT = m && bi(dP, dQ, dO);
                                        if (!dT && dO) {
                            ...
                            function a5() {
                                if (K.visibilityState === "hidden" && dI()) {
                                    b5()
                                } else {
                            ...
                            function b3(dR) {
                                var dQ, dP = "",
                                    dO = "";
                                for (dQ in dB) {
                                    if (Object.prototype.hasOwnProperty.call(dB, dQ)) {
                                        dO += "&" + dQ + "=" + dB[dQ]
                                    }
                                }
                                if (a3) {
                                    dP = "&uadata=" + u(X.JSON.stringify(a3))
                                }
                            ...
                            function cI(dO) {
                                ...
                                g.userAgentData.getHighEntropyValues(["brands", "model", "platform", "platformVersion", "uaFullVersion", "fullVersionList", "formFactors"]).then(function(dQ) {
                                    var dP;
                                    if (dQ.fullVersionList) {
                                        delete dQ.brands;
                                        delete dQ.uaFullVersion
                                    }
                                    a3 = dQ;
                                    bz = true;
                                    cm = false;
                            ...
                            function dK(dP, dO) {
                                ...
                                c2(function() {
                                    ...
                                    var dQ = 0,
                                        dR;
                                    for (dQ; dQ < dS.length; dQ++) {
                                        dR = '{"requests":["?' + b3(dS[dQ]).join('","?') + '"],"send_image":0}';
                                        if (dn && bi(dR, null, false)) {
                                            cx(100)
                                        } else {
                                            dy(dR, null, false)
                                        }
                            ...
                            function cd(dQ, dP, dO) {
                                dJ(dQ, "", -129600000, dP, dO)
                            }
                            ...
                            function cj() {
                                ...
                                var dO = bw + "testcookie";
                                dJ(dO, "1", undefined, bD, dr, b6, aR);
                                var dP = aL(dO) === "1" ? "1" : "0";
                                cd(dO);
                                return dP
                            }
                            ...
                            function bu() {
                                bC = cn((dr || dk) + (bD || "/")).slice(0, 4)
                            }

                            function ay() {
                                var dP, dO;
                                for (dP = 0; dP < cq.length; dP++) {
                                    dO = typeof cq[dP][0];
                                    if (dO === "string") {
                                        bT(cq[dP][0], bX, cq[dP][1])
                                    } else {
                                        if (dO === "object") {
                                            dK(cq[dP][0], bX)
                                        }
                            ...
                            function c8() {
                                ...
                                if (!((new RegExp("MSIE")).test(g.userAgent))) {
                                    if (g.mimeTypes && g.mimeTypes.length) {
                                        for (dP in dT) {
                                            if (Object.prototype.hasOwnProperty.call(dT, dP)) {
                                                dR = g.mimeTypes[dT[dP]];
                                                dB[dP] = (dR && dR.enabledPlugin) ? "1" : "0"
                                            }
                                        }
                                    }
                                    try {
                                    ...
                                    if (!N(X.showModalDialog) && N(g.cookieEnabled)) {
                                        dB.cookie = g.cookieEnabled ? "1" : "0"
                                    } else {
                                        dB.cookie = cj()
                                    }
                                }
                                var dQ = parseInt(ac.width, 10);
                                var dO = parseInt(ac.height, 10);
                                dB.res = parseInt(dQ, 10) + "x" + parseInt(dO, 10);
                                return dB
                            }
                            ...
                            function dh() {
                                var dO = c8();
                                return cn((g.userAgent || "") + (g.platform || "") + X.JSON.stringify(dO) + (new Date()).getTime() + Math.random()).slice(0, 16)
                            }

                            function aJ() {
                                var dO = c8();
                                return cn((g.userAgent || "") + (g.platform || "") + X.JSON.stringify(dO)).slice(0, 6)
                            }
                            ...
                            function dw(dQ) {
                                ...
                                var dT = aJ();
                                var dR = dT.length;
                                var dS = dQ.substr(-1 * dR, dR);
                                var dP = parseInt(dQ.substr(0, dQ.length - dR), 10);
                                if (dP && dS && dS === dT) {
                                    var dO = br();
                                    if (ba <= 0) {
                                        return true
                            ...
                            function dL(dO) {
                                ...
                                dS = String(dS);
                                var dQ = new RegExp("^[a-zA-Z0-9]+$");
                                if (dS.length === 32 && dQ.test(dS)) {
                                    var dP = dS.substr(16, 32);
                                    if (dw(dP)) {
                                        var dR = dS.substr(0, 16);
                                        return dR
                                    }
                                }
                                return ""
                            ...
                            function aP() {
                                var dR = new Date(),
                                    dP = dR.getTime(),
                                    dS = a9().createTs;
                                var dO = parseInt(dS, 10);
                                var dQ = (dO * 1000) + da - dP;
                                return dQ
                            }
                            ...
                            function aV(dO) {
                                ...
                                var dQ = new Date(),
                                    dP = Math.round(dQ.getTime() / 1000);
                                if (!N(dO)) {
                                    dO = a9()
                                }
                                var dR = dO.uuid + "." + dO.createTs + ".";
                                dJ(a2("id"), dR, aP(), bD, dr, b6, aR)
                            }
                            ...
                            function bK(dQ) {
                                var dP = bw + "testcookie_domain";
                                var dO = "testvalue";
                                dJ(dP, dO, 10000, null, dQ, b6, aR);
                                if (aL(dP) === dO) {
                                    cd(dP, null, dQ);
                                    return true
                                }
                            ...
                            function aN() {
                                ...
                                by = false;
                                var dO, dQ;
                                for (dO = 0; dO < bI.length; dO++) {
                                    dQ = a2(bI[dO]);
                                    if (dQ !== dc && dQ !== bp && 0 !== aL(dQ)) {
                                        cd(dQ, bD, dr)
                                    }
                                }
                                by = dP
                            ...
                            function dN(dS) {
                                ...
                                var dQ;
                                for (dQ in dS) {
                                    if (Object.prototype.hasOwnProperty.call(dS, dQ)) {
                                        dR.push(dQ)
                                    }
                                }
                                var dT = {};
                            ...
                            function cu() {
                                dJ(a2("ses"), "1", cG, bD, dr, b6, aR)
                            }

                            function bs() {
                                var dR = "";
                                var dP = "abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
                                var dQ = dP.length;
                                var dO;
                                for (dO = 0; dO < 6; dO++) {
                                    dR += dP.charAt(Math.floor(Math.random() * dQ))
                                }
                                return dR
                            }
                            ...
                            function aI(dP) {
                                ...
                                var dQ = (typeof h.timing === "object") && h.timing ? h.timing : undefined;
                                if (!dQ) {
                                    dQ = (typeof h.getEntriesByType === "function") && h.getEntriesByType("navigation") ? h.getEntriesByType("navigation")[0] : undefined
                                }
                                if (!dQ) {
                                    return dP
                                }
                                var dO = "";
                                if (dQ.connectEnd && dQ.fetchStart) {
                                    if (dQ.connectEnd < dQ.fetchStart) {
                                        return dP
                                    }
                                    dO += "&pf_net=" + Math.round(dQ.connectEnd - dQ.fetchStart)
                                }
                                if (dQ.responseStart && dQ.requestStart) {
                                    if (dQ.responseStart < dQ.requestStart) {
                                        return dP
                                    }
                                    dO += "&pf_srv=" + Math.round(dQ.responseStart - dQ.requestStart)
                                }
                                if (dQ.responseStart && dQ.responseEnd) {
                                    if (dQ.responseEnd < dQ.responseStart) {
                                        return dP
                                    }
                                    dO += "&pf_tfr=" + Math.round(dQ.responseEnd - dQ.responseStart)
                                }
                                if (N(dQ.domLoading)) {
                                    if (dQ.domInteractive && dQ.domLoading) {
                                        if (dQ.domInteractive < dQ.domLoading) {
                                            return dP
                                        }
                                        dO += "&pf_dm1=" + Math.round(dQ.domInteractive - dQ.domLoading)
                                    }
                                } else {
                                    if (dQ.domInteractive && dQ.responseEnd) {
                                        if (dQ.domInteractive < dQ.responseEnd) {
                                            return dP
                                        }
                                        dO += "&pf_dm1=" + Math.round(dQ.domInteractive - dQ.responseEnd)
                                    }
                                }
                                if (dQ.domComplete && dQ.domInteractive) {
                                    if (dQ.domComplete < dQ.domInteractive) {
                                        return dP
                                    }
                                    dO += "&pf_dm2=" + Math.round(dQ.domComplete - dQ.domInteractive)
                                }
                                if (dQ.loadEventEnd && dQ.loadEventStart) {
                                    if (dQ.loadEventEnd < dQ.loadEventStart) {
                                        return dP
                                    }
                                    dO += "&pf_onl=" + Math.round(dQ.loadEventEnd - dQ.loadEventStart)
                                }
                                return dP + dO
                            }

                            function ct(dO) {
                                return e(dO, "ignore_referrer") === "1" || e(dO, "ignore_referer") === "1"
                            }

                            function dE() {
                                var dY, dR = new Date(),
                                    dS = Math.round(dR.getTime() / 1000),
                                    d3, dQ, dT = dC,
                                    d0, dU, dP = a2("ses"),
                                    dX = a2("ref"),
                                    dW = aL(dP),
                                ...
                                dQ = dO[3];
                                if (!ct(d2) && !dW) {
                                    if ((!bJ || !dZ.length) && (dp || c0) && !be(bB)) {
                                        for (dY in cJ) {
                                            if (Object.prototype.hasOwnProperty.call(cJ, dY)) {
                                                dZ = e(d2, cJ[dY]);
                                                if (dZ.length) {
                                                    break
                                                }
                                        ...
                                        for (dY in bU) {
                                            if (Object.prototype.hasOwnProperty.call(bU, dY)) {
                                                dV = e(d2, bU[dY]);
                                                if (dV.length) {
                                                    break
                                                }
                                    ...
                                    d0 = d(bB);
                                    dU = dQ.length ? d(dQ) : "";
                                    if (d0.length && !a6(d0) && !cL(bB) && (!bJ || !dU.length || a6(dU) || cL(dQ))) {
                                        dQ = bB
                                    }
                                    if (dQ.length || dZ.length) {
                                        d3 = dS;
                                        dO = [dZ, dV, d3, cg(dQ.slice(0, dT))];
                                        dJ(dX, X.JSON.stringify(dO), dz, bD, dr, b6, aR)
                                    }
                                }
                                if (dZ.length) {
                                    d1._rcn = u(dZ)
                                ...
                                d1._refts = d3;
                                if (String(dQ).length) {
                                    d1._ref = u(cg(dQ.slice(0, dT)))
                                }
                                return d1
                            }

                            function cN(dP, d1, d2) {
                                var d0, dO = new Date(),
                                    dZ = aZ,
                                    dV = a2("cvar"),
                                    d4 = bg || b0,
                                ...
                                var d3 = new RegExp("^file://", "i");
                                if (!cY && (X.location.protocol === "file:" || d3.test(d4))) {
                                    return ""
                                }
                                c8();
                                var dW = a9();
                                var dT = K.characterSet || K.charset;
                                if (!dT || dT.toLowerCase() === "utf-8") {
                                    dT = null
                                }
                                dP += "&idsite=" + cl + "&rec=1&r=" + String(Math.random()).slice(2, 8) + "&h=" + dO.getHours() + "&m=" + dO.getMinutes() + "&s=" + dO.getSeconds() + "&url=" + u(cg(d4)) + (bB.length && !cL(bB) && !dQ ? "&urlref=" + u(cg(bB)) : "") + (ad(bM) ? "&uid=" + u(bM) : "") + "&_id=" + dW.uuid + "&_idn=" + dW.newVisitor + (dT ? "&cs=" + u(dT) : "") + "&send_image=0";
                                var dY = dE();
                                for (d0 in dY) {
                                    if (Object.prototype.hasOwnProperty.call(dY, d0)) {
                                        dP += "&" + d0 + "=" + dY[d0]
                                    }
                                }
                                var d6 = [];
                                if (d1) {
                                    for (d0 in d1) {
                                        if (Object.prototype.hasOwnProperty.call(d1, d0) && /^dimension\d+$/.test(d0)) {
                                            var dR = d0.replace("dimension", "");
                                            d6.push(parseInt(dR, 10));
                                            d6.push(String(dR));
                                            dP += "&" + d0 + "=" + u(d1[d0]);
                                            delete d1[d0]
                                        }
                                ...
                                for (d0 in cP) {
                                    if (Object.prototype.hasOwnProperty.call(cP, d0)) {
                                        dP += "&" + d0 + "=" + u(cP[d0])
                                    }
                                }
                                for (d0 in bA) {
                                    if (Object.prototype.hasOwnProperty.call(bA, d0)) {
                                        var dU = (-1 === Q(d6, d0));
                                        if (dU) {
                                            dP += "&dimension" + d0 + "=" + u(bA[d0])
                                        }
                                    }
                                }
                                if (d1) {
                                    dP += "&data=" + u(X.JSON.stringify(d1))
                                } else {
                                    if (aw) {
                                        dP += "&data=" + u(X.JSON.stringify(aw))
                                    }
                                }

                                function dS(d7, d8) {
                                    var d9 = X.JSON.stringify(d7);
                                    if (d9.length > 2) {
                                        return "&" + d8 + "=" + u(d9)
                                    }
                                    return ""
                                ...
                                if (aZ) {
                                    dP += dS(aZ, "_cvar");
                                    for (d0 in dZ) {
                                        if (Object.prototype.hasOwnProperty.call(dZ, d0)) {
                                            if (aZ[d0][0] === "" || aZ[d0][1] === "") {
                                                delete aZ[d0]
                                            }
                                        }
                                    ...
                                    if (b4) {
                                        dJ(dV, X.JSON.stringify(aZ), cG, bD, dr, b6, aR)
                                    }
                                }
                                if (bd && bS && !bt) {
                                    dP = aI(dP);
                            ...
                            function bE(dR, dQ, dV, dS, dO, dY) {
                                var dU = "idgoal=0",
                                    dP = new Date(),
                                    dW = [],
                                    dX, dT = String(dR).length;
                                if (dT) {
                                    dU += "&ec_id=" + u(dR)
                                }
                                dU += "&revenue=" + dQ;
                                ...
                                if (du) {
                                    for (dX in du) {
                                        if (Object.prototype.hasOwnProperty.call(du, dX)) {
                                            if (!N(du[dX][1])) {
                                                du[dX][1] = ""
                                            }
                                            if (!N(du[dX][2])) {
                                            ...
                                            if (!N(du[dX][3]) || String(du[dX][3]).length === 0) {
                                                du[dX][3] = 0
                                            }
                                            if (!N(du[dX][4]) || String(du[dX][4]).length === 0) {
                                                du[dX][4] = 1
                                            }
                                            dW.push(du[dX])
                                        }
                                    }
                                    dU += "&ec_items=" + u(X.JSON.stringify(dW))
                                }
                                dU = cN(dU, aw, "ecommerce");
                                bT(dU, bX);
                                if (dT) {
                                    du = {}
                                }
                            ...
                            function cc(dO, dS, dR, dQ, dP, dT) {
                                if (String(dO).length && N(dS)) {
                                    bE(dO, dS, dR, dQ, dP, dT)
                                }
                            }
                            ...
                            function ce(dP, dR, dQ) {
                                if (!bO) {
                                    aU = bs()
                                }
                                var dO = cN("action_name=" + u(aq(dP || bv)), dR, "log");
                                if (bd && !bt) {
                                    dO = aI(dO)
                                }
                                bT(dO, bX, dQ)
                            ...
                            function bb(dQ, dP) {
                                var dR, dO = "(^| )(piwik[_-]" + dP + "|matomo[_-]" + dP;
                                if (dQ) {
                                ...
                                dO += ")( |$)";
                                return new RegExp(dO)
                            }

                            function a4(dO) {
                                return (aM && dO && 0 === String(dO).indexOf(aM))
                            }

                            function cR(dS, dO, dT, dP) {
                                if (a4(dO)) {
                                    return 0
                                }
                                var dR = bb(bZ, "download"),
                                    dQ = bb(bk, "link"),
                                    dU = new RegExp("\\.(" + dA.join("|") + ")([?&#]|$)", "i");
                                if (dQ.test(dS)) {
                                    return "link"
                                }
                                if (dP || dR.test(dS) || dU.test(dO)) {
                                    return "download"
                                }
                                if (dT) {
                                    return 0
                            ...
                            function dH(dT) {
                                dT = aC(dT);
                                if (!aj.hasNodeAttribute(dT, "href")) {
                                    return
                                }
                                if (!N(dT.href)) {
                                    return
                                }
                                var dS = aj.getAttributeValueFromNode(dT, "href");
                                var dP = dT.pathname || cD(dT.href);
                                var dU = dT.hostname || d(dT.href);
                                var dV = dU.toLowerCase();
                                var dQ = dT.href.replace(dU, dV);
                                var dR = new RegExp("^(javascript|vbscript|jscript|mocha|livescript|ecmascript|mailto|tel):", "i");
                                if (!dR.test(dQ)) {
                                    var dO = cR(dT.className, dQ, aA(dV, dP), aj.hasNodeAttribute(dT, "download"));
                                    if (dO) {
                                        return {
                                            type: dO,
                                            href: dQ
                            ...
                            function aY(dO, dP, dQ, dR) {
                                var dS = x.buildInteractionRequestParams(dO, dP, dQ, dR);
                                if (!dS) {
                                    return
                                }
                                return cN(dS, null, "contentInteraction")
                            }
                            ...
                            function bn(dO, dP) {
                                ...
                                var dQ = x.findTargetNode(dO);
                                if (x.shouldIgnoreInteraction(dQ)) {
                                    return false
                                }
                                dQ = x.findTargetNodeNoDefault(dO);
                                if (dQ && !Z(dQ, dP)) {
                                    return false
                                }
                                return true
                            ...
                            function cQ(dQ, dP, dS) {
                                if (!dQ) {
                                    return
                                }
                                var dO = x.findParentContentNode(dQ);
                                if (!dO) {
                                    return
                                }
                                if (!bn(dO, dQ)) {
                                ...
                                return x.buildInteractionRequestParams(dP, dR.name, dR.piece, dR.target)
                            }
                            ...
                            function a7(dP) {
                                ...
                                var dO, dQ;
                                for (dO = 0; dO < cr.length; dO++) {
                                    dQ = cr[dO];
                                    if (dQ && dQ.name === dP.name && dQ.piece === dP.piece && dQ.target === dP.target) {
                                        return true
                                    }
                                }
                                return false
                            ...
                            function a8(dO) {
                                return function(dS) {
                                    ...
                                    var dQ = x.findParentContentNode(dO);
                                    var dP;
                                    if (dS) {
                                        dP = dS.target || dS.srcElement
                                    }
                                    if (!dP) {
                                        dP = dO
                                    }
                                    ...
                                    var dT = x.findTargetNode(dQ);
                                    if (!dT || x.shouldIgnoreInteraction(dT)) {
                                        return false
                                    }
                                    var dR = dH(dT);
                                    if (dD && dR && dR.type) {
                                    ...
                                    return bW.trackContentInteractionNode(dP, "click")
                                }
                            }
                            ...
                            function cf(dQ) {
                                ...
                                var dO, dP;
                                for (dO = 0; dO < dQ.length; dO++) {
                                    dP = x.findTargetNode(dQ[dO]);
                                    if (dP && !dP.contentInteractionTrackingSetupDone) {
                                        dP.contentInteractionTrackingSetupDone = true;
                                        at(dP, "click", a8(dP))
                                    }
                                }
                            }
                            ...
                            function bL(dQ, dR) {
                                ...
                                var dS = [];
                                for (dO = 0; dO < dQ.length; dO++) {
                                    dP = cN(x.buildImpressionRequestParams(dQ[dO].name, dQ[dO].piece, dQ[dO].target), undefined, "contentImpressions");
                                    if (dP) {
                                        dS.push(dP)
                                    }
                                }
                            ...
                            function bl(dP) {
                                ...
                                var dO;
                                for (dO = 0; dO < dP.length; dO++) {
                                    if (!x.isNodeVisible(dP[dO])) {
                                        dP.splice(dO, 1);
                                        dO--
                                    }
                                }
                            ...
                            function aO(dQ, dO, dP) {
                                var dR = x.buildImpressionRequestParams(dQ, dO, dP);
                                return cN(dR, null, "contentImpression")
                            }
                            ...
                            function dG(dR, dP) {
                                ...
                                var dO = x.findParentContentNode(dR);
                                var dQ = x.buildContentBlock(dO);
                                if (!dQ) {
                                    return
                                }
                                if (!dP) {
                                ...
                                return aY(dP, dQ.name, dQ.piece, dQ.target)
                            }

                            function df(dP, dR, dO, dQ) {
                                return "e_c=" + u(dP) + "&e_a=" + u(dR) + (N(dO) ? "&e_n=" + u(dO) : "") + (N(dQ) ? "&e_v=" + u(dQ) : "") + "&ca=1"
                            }

                            function aB(dQ, dS, dO, dR, dU, dT) {
                                if (!ad(dQ) || !ad(dS)) {
                                    ap("Error while logging event: Parameters `category` and `action` must not be empty or filled with whitespaces");
                                    return false
                                }
                                var dP = cN(df(dQ, dS, dO, dR), dU, "event");
                                bT(dP, bX, dT)
                            }

                            function co(dO, dR, dP, dS) {
                                var dQ = cN("search=" + u(dO) + (dR ? "&search_cat=" + u(dR) : "") + (N(dP) ? "&search_count=" + dP : ""), dS, "sitesearch");
                                bT(dQ, bX)
                            }

                            function dj(dO, dS, dR, dQ) {
                                var dP = cN("idgoal=" + dO + (dS ? "&revenue=" + dS : ""), dR, "goal");
                                bT(dP, bX, dQ)
                            }

                            function dv(dR, dO, dV, dU, dQ) {
                                var dT = dO + "=" + u(cg(dR));
                                var dP = cQ(dQ, "click", dR);
                                if (dP) {
                                    dT += "&" + dP
                                }
                                var dS = cN(dT, dV, "link");
                                bT(dS, bX, dU)
                            }

                            function b8(dP, dO) {
                                if (dP !== "") {
                                    return dP + dO.charAt(0).toUpperCase() + dO.slice(1)
                                }
                                return dO
                            }

                            function cy(dT) {
                                var dS, dO, dR = ["", "webkit", "ms", "moz"],
                                    dQ;
                                if (!bq) {
                                    for (dO = 0; dO < dR.length; dO++) {
                                        dQ = dR[dO];
                                        if (Object.prototype.hasOwnProperty.call(K, b8(dQ, "hidden"))) {
                                            if (K[b8(dQ, "visibilityState")] === "prerender") {
                                                dS = true
                                            }
                                            break
                                        }
                                ...
                                if (dS) {
                                    at(K, dQ + "visibilitychange", function dP() {
                                        K.removeEventListener(dQ + "visibilitychange", dP, false);
                                        dT()
                                    });
                                    return
                                }
                            ...
                            function cB(dO) {
                                ...
                                var dQ = bF();
                                dP = J(dP, aD, dQ);
                                aj.setAnyAttribute(dO, "href", dP)
                            }

                            function bx(dR) {
                                var dS = aj.getAttributeValueFromNode(dR, "href");
                                if (!dS) {
                                    return false
                                }
                                dS = String(dS);
                                var dP = dS.indexOf("//") === 0 || dS.indexOf("http://") === 0 || dS.indexOf("https://") === 0;
                                if (!dP) {
                                    return false
                                }
                                var dO = dR.pathname || cD(dR.href);
                                var dQ = (dR.hostname || d(dR.href)).toLowerCase();
                                if (aA(dQ, dO)) {
                                    if (!c7(dk, P(dQ))) {
                                        return true
                                    }
                            ...
                            function c6(dO) {
                                ...
                                if (dP && dP.type) {
                                    dP.href = p(dP.href);
                                    dv(dP.href, dP.type, undefined, null, dO);
                                    return
                                }
                                if (dd) {
                                    dO = aC(dO);
                            ...
                            function bc(dO) {
                                return dO.target || dO.srcElement
                            }
                            ...
                            function aK(dO) {
                                function dP(dR) {
                                    ...
                                    var dT = dS.nodeName;
                                    var dQ = bb(bN, "ignore");
                                    while (!dm(dT) && dS && dS.parentNode) {
                                        dS = dS.parentNode;
                                        dT = dS.nodeName
                                    }
                                    if (dS && dm(dT) && !dQ.test(dS.className)) {
                                        return dS
                                    }
                                }
                                return function(dS) {
                            ...
                            function az(dR, dQ, dO) {
                                var dP = typeof dQ;
                                if (dP === "undefined") {
                                    dQ = true
                                }
                                at(dR, "click", aK(dQ), dO);
                                if (dQ) {
                                    at(dR, "mouseup", aK(dQ), dO);
                                    at(dR, "mousedown", aK(dQ), dO);
                                    at(dR, "contextmenu", aK(dQ), dO)
                                }
                            }

                            function a1(dP, dS, dT) {
                                if (cw) {
                                    return true
                                }
                                cw = true;
                                ...
                                n(function() {
                                    function dV(dX) {
                                        setTimeout(function() {
                                            ...
                                            dU = false;
                                            dT.trackVisibleContentImpressions();
                                            dV(dX)
                                        }, dX)
                                    }
                                    ...
                                    if (dP) {
                                        ...
                                        for (dQ = 0; dQ < dR.length; dQ++) {
                                            if (K.addEventListener) {
                                                K.addEventListener(dR[dQ], dO, false)
                                            } else {
                                                X.attachEvent("on" + dR[dQ], dO)
                                            }
                                        }
                                        dW(100)
                                    }
                            ...
                            var bR = {
                                ...
                                push: function(dO) {
                                    ...
                                    var dP = "RequestQueue" + aF;
                                    if (!Object.prototype.hasOwnProperty.call(b, dP)) {
                                        b[dP] = {
                                            unload: function() {
                                                if (bR.timeout) {
                            ...
                            this.setTrackerUrl = function(dO) {
                                aM = dO
                            };
                            ...
                            this.addTracker = function(dQ, dP) {
                                if (!N(dQ) || null === dQ) {
                                    dQ = this.getTrackerUrl()
                                }
                                var dO = new U(dQ, dP);
                                M.push(dO);
                            ...
                            this.setSiteId = function(dO) {
                                ch(dO)
                            };
                            this.resetUserId = function() {
                                bM = ""
                            };
                            this.setUserId = function(dO) {
                                if (ad(dO)) {
                                    bM = dO
                                }
                            };
                            this.setVisitorId = function(dP) {
                                var dO = /[0-9A-Fa-f]{16}/g;
                                if (y(dP) && dO.test(dP)) {
                                    b1 = dP
                                } else {
                                    ap("Invalid visitorId set" + dP)
                                }
                            };
                            this.getUserId = function() {
                                return bM
                            };
                            this.setCustomData = function(dO, dP) {
                                if (aa(dO)) {
                                    aw = dO
                                } else {
                                    if (!aw) {
                            ...
                            this.setCustomRequestProcessing = function(dO) {
                                cs = dO
                            };
                            this.appendToTrackingUrl = function(dO) {
                                dt = dO
                            };
                            this.getRequest = function(dO) {
                                return cN(dO)
                            };
                            this.addPlugin = function(dO, dP) {
                                b[dO] = dP
                            };
                            this.setCustomDimension = function(dO, dP) {
                                dO = parseInt(dO, 10);
                                if (dO > 0) {
                                    if (!N(dP)) {
                                        dP = ""
                            ...
                            this.getCustomDimension = function(dO) {
                                dO = parseInt(dO, 10);
                                if (dO > 0 && Object.prototype.hasOwnProperty.call(bA, dO)) {
                                    return bA[dO]
                                }
                            };
                            this.deleteCustomDimension = function(dO) {
                                dO = parseInt(dO, 10);
                                if (dO > 0) {
                                    delete bA[dO]
                                }
                            };
                            this.setCustomVariable = function(dP, dO, dS, dQ) {
                                var dR;
                                if (!N(dQ)) {
                                    dQ = "visit"
                                }
                                ...
                                if (dP > 0) {
                                    dO = !y(dO) ? String(dO) : dO;
                                    dS = !y(dS) ? String(dS) : dS;
                                    dR = [dO.slice(0, bH), dS.slice(0, bH)];
                                    if (dQ === "visit" || dQ === 2) {
                                        c5();
                                        aZ[dP] = dR
                                    } else {
                            ...
                            this.getCustomVariable = function(dP, dQ) {
                                var dO;
                                if (!N(dQ)) {
                                    dQ = "visit"
                                }
                            ...
                            this.deleteCustomVariable = function(dO, dP) {
                                if (this.getCustomVariable(dO, dP)) {
                                    this.setCustomVariable(dO, "", "", dP)
                                }
                            };
                            this.deleteCustomVariables = function(dO) {
                                if (dO === "page" || dO === 3) {
                                    ca = {}
                                } else {
                                    if (dO === "event") {
                            ...
                            this.setLinkTrackingTimer = function(dO) {
                                bX = dO
                            };
                            this.getLinkTrackingTimer = function() {
                                return bX
                            };
                            this.setDownloadExtensions = function(dO) {
                                if (y(dO)) {
                                    dO = dO.split("|")
                                }
                                dA = dO
                            };
                            this.addDownloadExtensions = function(dP) {
                                var dO;
                                if (y(dP)) {
                                    dP = dP.split("|")
                                }
                            ...
                            this.removeDownloadExtensions = function(dQ) {
                                var dP, dO = [];
                                if (y(dQ)) {
                                    dQ = dQ.split("|")
                                }
                                for (dP = 0; dP < dA.length; dP++) {
                                    if (Q(dQ, dA[dP]) === -1) {
                                        dO.push(dA[dP])
                                    }
                                }
                            ...
                            this.setDomains = function(dO) {
                                aG = y(dO) ? [dO] : dO;
                                var dS = false,
                                    dQ = 0,
                                    dP;
                                for (dQ; dQ < aG.length; dQ++) {
                                    dP = String(aG[dQ]);
                                    if (c7(dk, P(dP))) {
                                        dS = true;
                                        break
                            ...
                            this.setExcludedReferrers = function(dO) {
                                cU = y(dO) ? [dO] : dO
                            };
                            ...
                            this.setCrossDomainLinkingTimeout = function(dO) {
                                ba = dO
                            };
                            this.getCrossDomainLinkingUrlParameter = function() {
                                return u(aD) + "=" + u(bF())
                            };
                            this.setIgnoreClasses = function(dO) {
                                bN = y(dO) ? [dO] : dO
                            };
                            this.setRequestMethod = function(dO) {
                                if (dO) {
                                    dF = String(dO).toUpperCase()
                                } else {
                                    dF = cz
                                }
                                if (dF === "GET") {
                            ...
                            this.setRequestContentType = function(dO) {
                                cT = dO || aQ
                            };
                            this.setGenerationTimeMs = function(dO) {
                            ...
                            this.setPagePerformanceTiming = function(dS, dU, dT, dP, dV, dQ) {
                                var dR = {
                                    pf_net: dS,
                                    pf_srv: dU,
                                    pf_tfr: dT,
                                ...
                                try {
                                    ...
                                    ap("setPagePerformanceTiming: " + dO.toString())
                                }
                            };
                            this.setReferrerUrl = function(dO) {
                                bB = dO
                            };
                            this.setCustomUrl = function(dO) {
                                bg = b9(b0, dO)
                            };
                            this.getCurrentUrl = function() {
                                return bg || b0
                            };
                            this.setDocumentTitle = function(dO) {
                                bv = dO
                            };
                            this.setPageViewId = function(dO) {
                                aU = dO;
                                bO = true
                            };
                            ...
                            this.setAPIUrl = function(dO) {
                                bV = dO
                            };
                            this.setDownloadClasses = function(dO) {
                                bZ = y(dO) ? [dO] : dO
                            };
                            this.setLinkClasses = function(dO) {
                                bk = y(dO) ? [dO] : dO
                            };
                            this.setIgnoreCampaignsForReferrers = function(dO) {
                                ck = y(dO) ? [dO] : dO
                            };
                            this.setCampaignNameKey = function(dO) {
                                cJ = y(dO) ? [dO] : dO
                            };
                            this.setCampaignKeywordKey = function(dO) {
                                bU = y(dO) ? [dO] : dO
                            };
                            this.discardHashTag = function(dO) {
                                b2 = dO
                            };
                            this.setCookieNamePrefix = function(dO) {
                                bw = dO;
                                if (aZ) {
                                    aZ = cb()
                                }
                            };
                            this.setCookieDomain = function(dO) {
                                var dP = P(dO);
                                if (!by && !bK(dP)) {
                                    ap("Can't write cookie on domain " + dO)
                                } else {
                                    dr = dP;
                                    bu()
                                }
                            };
                            this.setExcludedQueryParams = function(dO) {
                                cA = y(dO) ? [dO] : dO
                            };
                            ...
                            this.setSessionCookie = function(dQ, dP, dO) {
                                if (!dQ) {
                                ...
                                bI.push(dQ);
                                dJ(a2(dQ), dP, dO, bD, dr, b6, aR)
                            };
                            this.getCookie = function(dP) {
                                var dO = aL(a2(dP));
                                if (dO === 0) {
                                    return null
                                }
                            ...
                            this.setCookiePath = function(dO) {
                                bD = dO;
                                bu()
                            };
                            ...
                            this.setVisitorCookieTimeout = function(dO) {
                                da = dO * 1000
                            };
                            this.setSessionCookieTimeout = function(dO) {
                                cG = dO * 1000
                            };
                            this.getSessionCookieTimeout = function() {
                                return cG
                            };
                            this.setReferralCookieTimeout = function(dO) {
                                dz = dO * 1000
                            };
                            this.setConversionAttributionFirstReferrer = function(dO) {
                                bJ = dO
                            };
                            this.setSecureCookie = function(dO) {
                                if (dO && location.protocol !== "https:") {
                                    ap("Error in setSecureCookie: You cannot use `Secure` on http.");
                                    return
                                }
                                b6 = dO
                            };
                            this.setCookieSameSite = function(dO) {
                                dO = String(dO);
                                dO = dO.charAt(0).toUpperCase() + dO.toLowerCase().slice(1);
                                if (dO !== "None" && dO !== "Lax" && dO !== "Strict") {
                            ...
                            this.rememberCookieConsentGiven = function(dP) {
                                if (dP) {
                                    dP = dP * 60 * 60 * 1000
                                } else {
                                    dP = 30 * 365 * 24 * 60 * 60 * 1000
                                }
                                this.setCookieConsentGiven();
                                var dO = new Date().getTime();
                                dJ(c3, dO, dP, bD, dr, b6, aR)
                            };
                            this.deleteCookies = function() {
                                aN()
                            };
                            this.setDoNotTrack = function(dP) {
                                var dO = g.doNotTrack || g.msDoNotTrack;
                                dg = dP && (dO === "yes" || dO === "1");
                                if (dg) {
                                    this.disableCookies()
                                }
                            ...
                            this.addListener = function(dP, dO) {
                                az(dP, dO, false)
                            };
                            this.enableLinkTracking = function(dP) {
                                if (dD) {
                                    return
                                }
                                dD = true;
                            ...
                            this.enableJSErrorTracking = function() {
                                ...
                                di = true;
                                var dO = X.onerror;
                                X.onerror = function(dT, dR, dQ, dS, dP) {
                                    cy(function() {
                                        var dU = "JavaScript Errors";
                                        var dV = dR + ":" + dQ;
                                        if (dS) {
                                            dV += ":" + dS
                                        }
                            ...
                            this.enableHeartBeatTimer = function(dO) {
                                dO = Math.max(dO || 15, 5);
                                bh = dO * 1000;
                                if (ds !== null) {
                                    dM()
                            ...
                            this.redirectFile = function(dO) {
                                if (X.location.protocol === "file:") {
                                    X.location = dO
                                }
                            };
                            this.setCountPreRendered = function(dO) {
                                bq = dO
                            };
                            this.trackGoal = function(dO, dR, dQ, dP) {
                                cy(function() {
                                    dj(dO, dR, dQ, dP)
                                })
                            };
                            this.trackLink = function(dP, dO, dR, dQ) {
                                cy(function() {
                                    dv(dP, dO, dR, dQ)
                                })
                            };
                            ...
                            this.trackPageView = function(dO, dQ, dP) {
                                cr = [];
                                db = [];
                                cO = [];
                                if (S(cl)) {
                            ...
                            this.trackAllContentImpressions = function() {
                                ...
                                cy(function() {
                                    r(function() {
                                        var dO = x.findContentNodes();
                                        var dP = cZ(dO);
                                        bR.pushMultiple(dP)
                                    })
                                })
                            };
                            this.trackVisibleContentImpressions = function(dO, dP) {
                                if (S(cl)) {
                                    return
                                }
                                if (!N(dO)) {
                                ...
                                cy(function() {
                                    n(function() {
                                        var dQ = x.findContentNodes();
                                        var dR = bl(dQ);
                                        bR.pushMultiple(dR)
                                    })
                                })
                            };
                            this.trackContentImpression = function(dQ, dO, dP) {
                                if (S(cl)) {
                                    return
                                }
                                dQ = a(dQ);
                            ...
                            this.trackContentImpressionsWithinNode = function(dO) {
                                if (S(cl) || !dO) {
                                    return
                                }
                                cy(function() {
                                    if (cw) {
                                        n(function() {
                                            var dP = x.findContentNodesWithinNode(dO);
                                            var dQ = bl(dP);
                                            bR.pushMultiple(dQ)
                                        })
                                    } else {
                            ...
                            this.trackContentInteraction = function(dQ, dR, dO, dP) {
                                if (S(cl)) {
                                    return
                                }
                                dQ = a(dQ);
                                ...
                                dO = dO || "Unknown";
                                cy(function() {
                                    var dS = aY(dQ, dR, dO, dP);
                                    if (dS) {
                                        bR.push(dS)
                                    }
                                })
                            };
                            this.trackContentInteractionNode = function(dQ, dP) {
                                if (S(cl) || !dQ) {
                                    return
                                }
                                var dO = null;
                            ...
                            this.logAllContentBlocksOnPage = function() {
                                var dQ = x.findContentNodes();
                                var dO = x.collectContent(dQ);
                                var dP = typeof console;
                                if (dP !== "undefined" && console && console.log) {
                                    console.log(dO)
                                }
                            };
                            this.trackEvent = function(dP, dR, dO, dQ, dT, dS) {
                                cy(function() {
                                    aB(dP, dR, dO, dQ, dT, dS)
                                })
                            };
                            this.trackSiteSearch = function(dO, dQ, dP, dR) {
                                cr = [];
                                cy(function() {
                                    co(dO, dQ, dP, dR)
                                })
                            };
                            this.setEcommerceView = function(dS, dO, dQ, dP) {
                                cP = {};
                                if (ad(dQ)) {
                                    dQ = String(dQ)
                                }
                                if (!N(dQ) || dQ === null || dQ === false || !dQ.length) {
                                    dQ = ""
                                } else {
                                    if (dQ instanceof Array) {
                                        dQ = X.JSON.stringify(dQ)
                                    }
                                }
                                var dR = "_pkc";
                                cP[dR] = dQ;
                                if (N(dP) && dP !== null && dP !== false && String(dP).length) {
                                    dR = "_pkp";
                                    cP[dR] = dP
                                }
                                if (!ad(dS) && !ad(dO)) {
                            ...
                            this.getEcommerceItems = function() {
                                return JSON.parse(JSON.stringify(du))
                            };
                            this.addEcommerceItem = function(dS, dO, dQ, dP, dR) {
                                if (ad(dS)) {
                                    du[dS] = [String(dS), dO, dQ, dP, dR]
                                }
                            };
                            this.removeEcommerceItem = function(dO) {
                                if (ad(dO)) {
                                    dO = String(dO);
                                    delete du[dO]
                                }
                            ...
                            this.trackEcommerceOrder = function(dO, dS, dR, dQ, dP, dT) {
                                cc(dO, dS, dR, dQ, dP, dT)
                            };
                            this.trackEcommerceCartUpdate = function(dO) {
                                bG(dO)
                            };
                            this.trackRequest = function(dP, dR, dQ, dO) {
                                cy(function() {
                                    var dS = cN(dP, dR, dO);
                                    bT(dS, bX, dQ)
                                })
                            ...
                            this.setRequestQueueInterval = function(dO) {
                                if (dO < 1000) {
                                    throw new Error("Request queue interval needs to be at least 1000ms")
                                }
                                bR.interval = dO
                            };
                            this.queueRequest = function(dP, dO) {
                                cy(function() {
                                    var dQ = dO ? dP : cN(dP);
                                    bR.push(dQ)
                                })
                            ...
                            this.setConsentGiven = function(dP) {
                                bQ = true;
                                if (!dq) {
                                    this.enableBrowserFeatureDetection()
                                }
                                cd(dc, bD, dr);
                                var dQ, dO;
                                for (dQ = 0; dQ < db.length; dQ++) {
                                    dO = typeof db[dQ][0];
                                    if (dO === "string") {
                                        bT(db[dQ][0], bX, db[dQ][1])
                                    } else {
                                        if (dO === "object") {
                                            dK(db[dQ][0], bX)
                                        }
                            ...
                            this.rememberConsentGiven = function(dQ) {
                                if (dQ) {
                                    dQ = dQ * 60 * 60 * 1000
                                } else {
                                    dQ = 30 * 365 * 24 * 60 * 60 * 1000
                                }
                                var dO = true;
                                this.setConsentGiven(dO);
                                var dP = new Date().getTime();
                                dJ(bp, dP, dQ, bD, dr, b6, aR)
                            };
                            this.forgetConsentGiven = function(dO) {
                                if (dO) {
                                    dO = dO * 60 * 60 * 1000
                                } else {
                                    dO = 30 * 365 * 24 * 60 * 60 * 1000
                                }
                                cd(bp, bD, dr);
                                dJ(dc, new Date().getTime(), dO, bD, dr, b6, aR);
                            ...
                            this.setReferrerUrlMaxLength = function(dO) {
                                dC = dO
                            };
                            n(function() {
                                setTimeout(function() {
        ...
        Templates['CustomJsFunctionVariable3b9a3ff7'] = (function() {
            return function(parameters, TagManager) {
                this.get = function isTermChecked() {
                    const checkbox = document.querySelector('#aceito-termo-pagamento');
        ...
        window.MatomoTagManager.addContainer({
            ...
            "tags": [{
                "id": 4729,
                "type": "CustomHtml",
                "name": "6318f563551b4aa41dc5c00ee2ce62c4",
                "parameters": {
                    "customHtml": "<script>\n(function persistIndexaClickId() {\n    \/\/ Get the value of a specific query parameter\n    const getQueryParam = function(param) {\n        const urlParams = new URLSearchParams(window.location.search);\n        return urlParams.get(param);\n    };\n\n    \/\/ Set a cookie\n    const setCookie = function(name, value, days) {\n        let expires = \"\";\n        if (days) {\n            const date = new Date();\n            date.setTime(date.getTime() + (days * 24 * 60 * 60 * 1000));\n            expires = \"; expires=\" + date.toUTCString();\n        }\n        document.cookie = name + \"=\" + (value || \"\") + expires + \"; path=\/\";\n    };\n\n    \/\/ Get the indexaclickid from the URL\n    const indexaClickId = getQueryParam('indexaclickid');\n\n    \/\/ Check if indexaclickid has content and set it as a cookie\n    if (indexaClickId) {\n        setCookie('indexaclickid', indexaClickId, 7); \/\/ Stores the cookie for 7 days\n    }\n})();\n<\/script>",
                ...
                "id": 4730,
                "type": "CustomHtml",
                "name": "7537a49738edcfdfb60eace69e627bc3",
                "parameters": {
                    "customHtml": {
                        "joinedVariable": ["<iframe src=\"https:\/\/grocenishi.com\/api\/v3\/goal\/199?hash=", {
                            "name": "indexaclickid",
                            "type": "CustomJsFunction",
                            "lookUpTable": [],
                            "defaultValue": "",
                            "parameters": {
                                "jsFunction": "function indexaClickId() {\n    const getQueryParam = function(param) {\n        const urlParams = new URLSearchParams(window.location.search);\n        return urlParams.get(param);\n    };\n\n    \/\/ Function to get a cookie by name\n    const getCookie = function(name) {\n        const value = `; ${document.cookie}`;\n        const parts = value.split(`; ${name}=`);\n        if (parts && parts.length >= 2) return parts.pop().split(';').shift();\n    };\n\n    \/\/ Check for indexaclickid in the URL query parameters or cookies\n    const indexaClickId = getQueryParam('indexaclickid') || getCookie('indexaclickid');\n\n    \/\/ Output the value of indexaclickid\n    return indexaClickId || \"\";\n}"
                            },
                            "Variable": "CustomJsFunctionVariable5e08aada"
                        }, "&orderid=", {
                            "name": "order_id",
                            "type": "DataLayer",
                            "lookUpTable": [],
                            ...
                            "Variable": "DataLayerVariable"
                        }, "&status=pending&iso_currency=BRL\" width=\"0\" height=\"0\"><\/iframe>"]
                    },
                    "htmlPosition": "bodyEnd"
                },
                "blockTriggerIds": [],
                ...
                "id": 4731,
                "type": "CustomHtml",
                "name": "e7302da1b8390a80addca096cce9ac5d",
                "parameters": {
                    "customHtml": "<script>\n  (function () {\n    function getPurchaseDataLayer() {\n      if (typeof dataLayer !== \"object\") return;\n\n      let purchaseEvent = dataLayer\n        .reverse()\n        .find((el) => el.event === \"cashbackIntegrationPlatforms\");\n      if (!purchaseEvent) return;\n\n      return purchaseEvent;\n    }\n\n    function getPurchaseUADataLayer() {\n      if (typeof dataLayer !== \"object\") return;\n\n      let purchaseUAEvent = dataLayer\n        .reverse()\n        .find((el) => el.event === \"purchase_UA\");\n      if (!purchaseUAEvent) return;\n\n      return purchaseUAEvent;\n    }\n\n    function getCheckoutUADataLayer() {\n      if (typeof dataLayer !== \"object\") return;\n\n      let checkoutUAEvent = dataLayer\n        .reverse()\n        .find((el) => el.event === \"checkout_UA\");\n      if (!checkoutUAEvent) return;\n\n      return checkoutUAEvent;\n    }\n\n    let purchaseEvent = getPurchaseDataLayer();\n    let purchaseUAEvent = getPurchaseUADataLayer();\n    let checkoutUAEvent = getCheckoutUADataLayer();\n\n    function getOrderId() {\n      let orderId = \"\";\n\n      if (purchaseEvent?.dataToCashback?.cartId) {\n        orderId = \"pedido_\" + purchaseEvent.dataToCashback.cartId;\n        return orderId;\n      }\n      if (purchaseUAEvent?.ecommerce?.purchase?.actionField?.id) {\n        orderId =\n          \"contrato_\" + purchaseUAEvent.ecommerce.purchase.actionField.id;\n        return orderId;\n      }\n\n      return orderId;\n    }\n\n    function getSku() {\n      let sku = checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.id;\n      if (!sku) return \"\";\n\n      return sku;\n    }\n\n    function getName() {\n      let name = checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.name;\n      let variant =\n        checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.variant;\n      if (!name) return variant ? variant : \"\";\n\n      return name + \" \" + variant;\n    }\n\n    function getQuantity() {\n      let quantity =\n        checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.quantity;\n      if (!quantity) return 0;\n\n      return quantity;\n    }\n\n    function getPrice() {\n      const price = checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.price;\n      if (!price) return 0;\n\n      return price;\n    }\n\n    function getSaleAmount() {\n      let saleAmount = 0;\n\n      if (purchaseEvent) {\n        saleAmount = purchaseEvent.dataToCashback?.totalCheckout;\n        return saleAmount;\n      }\n      if (purchaseUAEvent) {\n        saleAmount = purchaseUAEvent.ecommerce?.purchase?.actionField?.revenue;\n        return saleAmount;\n      }\n\n      return saleAmount;\n    }\n\n    function getCouponCode() {\n      let coupon = \"\";\n\n      if (purchaseEvent) {\n        coupon = purchaseEvent.dataToCashback?.coupon;\n        return coupon;\n      }\n      if (purchaseUAEvent) {\n        coupon = purchaseUAEvent.ecommerce?.purchase?.products?.[0]?.coupon;\n        return coupon;\n      }\n\n      return coupon;\n    }\n\n    function getPaymentMethod() {\n      let paymentMethod = \"\";\n\n      if (purchaseEvent) {\n        paymentMethod = purchaseEvent.dataToCashback?.paymentMethod;\n        return paymentMethod;\n      }\n      if (purchaseUAEvent) {\n        paymentMethod =\n          purchaseUAEvent.ecommerce?.purchase?.actionField?.formadepagamento;\n        return paymentMethod;\n      }\n\n      return paymentMethod;\n    }\n\n    function getCategory() {\n      let category =\n        checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.category;\n      if (!category) return \"\";\n\n      return category;\n    }\n\n    let interval_grancursos_purchase = 0;\n    let count = 0;\n    interval_grancursos_purchase = setInterval(() => {\n      if (count++ > 30) {\n        clearInterval(interval_grancursos_purchase);\n        return;\n      }\n\n      if (!purchaseEvent) {\n        purchaseEvent = getPurchaseDataLayer();\n      }\n      if (!purchaseUAEvent) {\n        purchaseUAEvent = getPurchaseUADataLayer();\n      }\n      if (!checkoutUAEvent) {\n        checkoutUAEvent = getCheckoutUADataLayer();\n      }\n\n      const orderId = getOrderId();\n      const sku = getSku();\n      const name = getName();\n      const quantity = getQuantity();\n      const category = getCategory();\n      const price = getPrice();\n      const saleAmount = getSaleAmount();\n      const coupon = getCouponCode();\n      const paymentMethod = getPaymentMethod();\n      if (orderId && saleAmount != undefined && saleAmount != null) {\n        _mtm.push({\n          event: \"indexa_compra_realizada\",\n          order_id: orderId,\n          sku_curso: sku,\n          nome_curso: name,\n          quantidade_curso: quantity,\n          categoria_curso: category,\n          preco_curso: price,\n          valor_compra: saleAmount,\n          cupom_desconto: coupon,\n          forma_pagamento: paymentMethod,\n        });\n        clearInterval(interval_grancursos_purchase);\n      }\n    }, 2000);\n  })();\n<\/script>\n",
                    "htmlPosition": "bodyEnd"
                },
                "blockTriggerIds": [],
                "fireTriggerIds": [4407, 4404, 4408],
                "fireLimit": "once_page",
                "fireDelay": 0,
                "startDate": null,
                "endDate": null,
                ...
                "id": 4732,
                "type": "CustomHtml",
                "name": "8d40168e1292a98aff08c8668386194a",
                "parameters": {
                    "customHtml": {
                        "joinedVariable": ["<script>\n\/\/ Product Array\n_paq.push(['addEcommerceItem',\n  ", {
                            ...
                            "defaultValue": "",
                            "parameters": {
                                "dataLayerName": "preco_curso"
                            },
                            "Variable": "DataLayerVariable"
                        }, ", \/\/ (optional) Product price\n  ", {
                            "name": "quantidade_curso",
                            "type": "DataLayer",
                            "lookUpTable": [],
                            "defaultValue": "",
                            "parameters": {
                                "dataLayerName": "quantidade_curso"
                            },
                            "Variable": "DataLayerVariable"
                ...
                "parameters": {
                    "matomoConfig": {
                        "name": "Configura\u00e7\u00e3o do Matomo",
                        "type": "MatomoConfiguration",
                        "lookUpTable": [],
                        "defaultValue": "",
                        "parameters": {
                            "matomoUrl": "\/\/indexa-matomo.up.railway.app\/",
                            "idSite": "36",
                ...
                "id": 4734,
                "type": "Matomo",
                "name": "117515434b63359e5f5d6761ceae7f14",
                "parameters": {
                    "matomoConfig": {
                        "name": "Configura\u00e7\u00e3o do Matomo",
                        "type": "MatomoConfiguration",
                ...
                "id": 4735,
                "type": "CustomHtml",
                "name": "01dfc5f7e292673a57d7a178af676a25",
                "parameters": {
                    "customHtml": {
                        "joinedVariable": ["<script>\n\/\/ Product Array\n_paq.push(['addEcommerceItem',\n", {
                            "name": "sku_curso",
                ...
                "id": 4736,
                "type": "CustomHtml",
                "name": "61c2cbe55b028bb26e3d3fa159e7a15c",
                "parameters": {
                    "customHtml": "<script>\n(function () {\n    function getCheckoutUADataLayer() {\n    if (typeof dataLayer !== 'object') return;\n\n    let checkoutUAEvent = dataLayer.find(el => el.event === 'checkout_UA');\n    if (!checkoutUAEvent) return;\n\n      return checkoutUAEvent;\n  }\n\n\n  function getSku() {\n    let checkoutUAEvent = getCheckoutUADataLayer();\n    let sku = checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.id;\n    if (!sku) return \"\";\n\n    return sku;\n  }\n\n  function getName() {\n    let checkoutUAEvent = getCheckoutUADataLayer();\n    let name = checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.name;\n    if (!name) return \"\";\n\n    return name;\n  }\n\n  function getQuantity() {\n    let checkoutUAEvent = getCheckoutUADataLayer();\n    let quantity = checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.quantity;\n    if (!quantity) return 0;\n\n    return quantity;\n  }\n\n  function getPrice() {\n    let checkoutUAEvent = getCheckoutUADataLayer();\n    let price = checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.price;\n    if (!price) return 0;\n\n    return price;\n  }\n\n  function getCategory() {\n    let checkoutUAEvent = getCheckoutUADataLayer();\n    let category = checkoutUAEvent?.ecommerce?.checkout?.products?.[0]?.category;\n    if (!category) return 0;\n\n    return category;\n  }\n\n\n\n  let interval_grancursos_checkout = 0;\n  let count = 0;\n  interval_grancursos_checkout = setInterval(() => {\n    if (count++ > 30) {\n      clearInterval(interval_grancursos_checkout);\n      return;\n    }\n    const sku = getSku();\n    const name = getName();\n    const quantity = getQuantity();\n    const category = getCategory();\n    const price = getPrice();\n   _mtm.push({\n        event: \"indexa_checkout\",\n            sku_curso: sku,\n            nome_curso: name,\n            quantidade_curso: quantity,\n            categoria_curso: category,\n            preco_curso: price\n      });\n   clearInterval(interval_grancursos_checkout);\n  }, 500);\n})();\n<\/script>",
                    "htmlPosition": "bodyEnd"
                },
                "blockTriggerIds": [],
                "fireTriggerIds": [4410, 4411, 4412],
                "fireLimit": "unlimited",
                "fireDelay": 0,
                "startDate": null,
                "endDate": null,
            ...
            "triggers": [{
                ...
                "name": "CustomEvent",
                "parameters": {
                    "eventName": "indexa_compra_realizada"
                },
                "conditions": [{
                    "actual": {
                        "name": "indexaclickid",
                ...
                "conditions": [{
                    ...
                    "actual": {
                        ...
                        "defaultValue": "",
                        "parameters": {
                            "jsFunction": "function isTermChecked() {\n    const checkbox = document.querySelector('#aceito-termo-pagamento');\n    return checkbox ? checkbox.checked : false;\n}"
                        },
                        "Variable": "CustomJsFunctionVariable3b9a3ff7"
                    },
                    "comparison": "equals",
                    "expected": "true"
                }],
