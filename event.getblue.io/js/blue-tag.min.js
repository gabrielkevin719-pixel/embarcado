    ...
    function(e, t) {
        ...
        t[e] = function(e, t) {
            ...
            n ? setTimeout((function() {
                ...
                fn: e,
                ctx: t
            }), "complete" === document.readyState || "interactive" === document.readyState ? setTimeout(r, 1) : i || (document.addEventListener ? (document.addEventListener("DOMContentLoaded", r, !1), window.addEventListener("load", r, !1)) : (document.attachEvent("onreadystatechange", a), window.attachEvent("onload", r)), i = !0))
        }
    }("documentReady", window), documentReady((function() {
        var e;
        (blue_obj[instId] = new blue_obj, window.blue_v = "24102025-1118", window.bluecpy_id = generateUid(), window.blue_ulc = "", setLastClickBlue(), !0 === isCookieEnabled()) && ("" != (e = getCookieBlue("blueID")) && "null" !== e && null !== e ? window.bluecpy_id = e : setCookieBlue("blueID", window.bluecpy_id, 365));
        !0 === isSessionStorageEnabled() && (null !== (e = getSessionStorage("blueID")) && "null" !== e ? window.bluecpy_id = e : setSessionStorage("blueID", window.bluecpy_id));
        !0 === isLocalStorageEnabled() && (null !== (e = getLocalStorage("blueID")) && "null" !== e ? window.bluecpy_id = e : setLocalStorage("blueID", window.bluecpy_id));
        ...
        for (idxCampaignId = 0; idxCampaignId < n.length; idxCampaignId++)
            for (idxPageType = 0; idxPageType < r.length; idxPageType++) executeRequests(n[idxCampaignId], r[idxPageType])
    };
...
loadFunction = function(exec, val) {
    ...
    var o = blue_obj[instId].getAttributes().pixelMode,
        n = [];
    if (o) {
        var i = blue_obj[instId].mountSourcePixel(e, t),
            r = createImgElement(i);
        n.push(r)
    } else {
        var a = blue_obj[instId].mountSource(e, t),
            u = createIframeElement(a);
        n.push(u);
        var l = blue_obj[instId].getSslWidget(e, t),
            c = createScriptElement(l);
        n.push(c)
    }
    createDivElement((function(e) {
        for (var t = 0; t < n.length; t++) document.getElementById(e).appendChild(n[t])
    }))
}, blue_obj = function() {}, blue_obj.prototype.getSrc = function() {
    ...
    var o = blue_obj[instId].getAttributes(),
        n = 1e13 * (Math.random() + "");
    return o.source + "?cId=" + e + "&tName=" + t + "&pId=" + o.blueProductId + "&revenue=" + o.transactionTotal + "&orderId=" + o.transactionId + "&fp=" + o.fingerprint + "&blueID=" + window.bluecpy_id + "&ulc=" + window.blue_ulc + "&v=" + window.blue_v + "&nocache=" + n
}, blue_obj.prototype.getSslWidget = function(e, t) {
    var o = blue_obj[instId].getAttributes(),
        n = 1e13 * (Math.random() + ""),
        i = 0;
    return top !== self && (i = 1), "https://widget.getblue.io/event/?cId=" + e + "&tName=" + t + "&pId=" + o.blueProductId + "&revenue=" + o.transactionTotal + "&orderId=" + o.transactionId + "&p1=&p2=e%3Dvp&p3=e%3Ddis&adce=1&dtycbr=87954&fp=" + o.fingerprint + "&blueID=" + window.bluecpy_id + "&ulc=" + window.blue_ulc + "&v=" + window.blue_v + "&if=" + i + "&nocache=" + n
}, blue_obj.prototype.mountSourcePixel = function(e, t) {
    var o = blue_obj[instId].getAttributes(),
        n = 1e13 * (Math.random() + "");
    return o.sourcePixel + "?cId=" + e + "&tName=" + t + "&pId=" + o.blueProductId + "&revenue=" + o.transactionTotal + "&orderId=" + o.transactionId + "&pixelMode=" + o.pixelMode + "&fp=" + o.fingerprint + "&blueID=" + window.bluecpy_id + "&ulc=" + window.blue_ulc + "&v=" + window.blue_v + "&nocache=" + n
    ...
    var e = {};
    return e.campaignId = this.campaignId || "", e.pageType = this.pageType || "", e.blueProductId = this.blueProductId || "", e.transactionTotal = this.transactionTotal || "", e.transactionId = this.transactionId || "", e.pixelMode = this.pixelMode || 0, e.fingerprint = this.fingerprint || "", e.source = blue_obj[instId].getSrc(), e.sourcePixel = blue_obj[instId].getSrcPixel(), e
}, createDivElement = function(e) {
    var t = "blue-tags-div";
    if (!document.getElementById(t)) {
        var o = document.createElement("div");
        o.setAttribute("id", t), o.setAttribute("style", "display:none;"), document.body.appendChild(o)
    }
    e(t)
